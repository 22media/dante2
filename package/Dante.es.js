...
import { EditorState, ContentBlock, genKey, convertToRaw, convertFromRaw, CompositeDecorator, getDefaultKeyBinding, Editor, Entity, RichUtils, DefaultDraftBlockRenderMap, SelectionState, Modifier, getVisibleSelectionRect, EditorBlock } from 'draft-js';
...
function (_React$Component) {
  ...
  function DanteEditor(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleHTMLPaste", function (text, html) {
      ...
      var newContentState = convertFromHTML(fixedHtml, true);
